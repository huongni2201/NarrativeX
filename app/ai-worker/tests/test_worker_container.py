...
def test_narration_worker_bootstraps_builtin_voice_from_r2_without_local_secret_mount() -> None:
    compose_lines = COMPOSE.read_text(encoding="utf-8").splitlines()
    narration_service = _service(compose_lines, "narration-worker")
    ...
    assert "VIENEU_REFERENCE_AUDIO_PATH: r2://${VIENEU_REFERENCE_AUDIO_R2_KEY:" in narration_service
