...
/**
 * Automated Video Quality Assurance service implementing 11-category failure taxonomy
 * and reason-aware non-blind retry recommendations according to ADR-0029 and ADR-0030.
 */
@Service
public class VideoQualityAssurance {
  ...
  public String recommendRetryAction(
    ...
    return switch (category) {
      ...
      case DURATION ->
          "Adjust target frame count or flag take for trimming in EditDecisionList.";
