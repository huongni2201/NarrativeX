  ...
  void generationUsesProjectApplicationAccessBoundary() {
    ...
    GenerationJob savedJob =
        GenerationJob.create(
            7L, JobType.STORY_ANALYZE, ResourceClass.PROVIDER_INTERACTIVE, "owner");
    ...
    EnqueueStoryAnalysisUseCase useCase =
        new EnqueueStoryAnalysisUseCase(
            jobRepository, operationPlanRepository, projectAccess, currentUserId);
