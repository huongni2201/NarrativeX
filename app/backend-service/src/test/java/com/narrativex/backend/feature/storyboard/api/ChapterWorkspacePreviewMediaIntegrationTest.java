...
class ChapterWorkspacePreviewMediaIntegrationTest {
  ...
  void setUp() {
    ...
    jdbcTemplate.update(
        ...
        REVISION_ID);
    jdbcTemplate.update(
        "INSERT INTO media_assets (id, account_id, asset_type, origin, storage_mode, storage_key, original_filename, content_type, size_bytes, sha256, status) "
  ...
  @Test
  void workspaceUsesCanonicalPreviewMediaAssetIdentity() throws Exception {
    mockMvc
