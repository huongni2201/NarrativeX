...
The previous ADR records were consolidated into these five canonical files and removed after migration. Use a new sequential ADR for a new cross-cutting decision.
