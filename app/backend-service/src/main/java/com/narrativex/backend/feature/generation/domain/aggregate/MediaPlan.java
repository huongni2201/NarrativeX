...
public record MediaPlan(
  ...
  public MediaPlan(
      ...
      Instant createdAt) {
    this(
        id, chapterId, chapterRowVersion, sourceHash, productionMode, revision, scenes, workload,
        estimatedCost, createdAt, null, "media-mvp-v1", "16:9", "STANDARD", null, null,
        null, null, null, null);
  }
  ...
  public MediaPlan {
    ...
    if (estimatedCost.signum() < 0) throw new IllegalArgumentException("estimatedCost must not be negative");
