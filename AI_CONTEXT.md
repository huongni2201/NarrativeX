...
| Backend/compute split | [ADR-0018](documentation/decisions/ADR-0018-backend-control-plane-and-domain-agnostic-gpu-execution-plane.md), [ADR-0025](documentation/decisions/ADR-0025-event-driven-compute-orchestration-and-reconciliation.md), [Compute Protocol](documentation/COMPUTE_PROTOCOL.md) |
