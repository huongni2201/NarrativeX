...
VALUES
    ...
    (13003, 'PRO', 1, FALSE, 'HIGH', 10, 20, 2, '{"storyAnalysis":true,"shorts":true,"narration":true}'::jsonb, 10.000000, CURRENT_TIMESTAMP),
...
VALUES
    ...
    (6103, (SELECT id FROM auth_users WHERE email = 'huongnn2201@gmail.com'), '2026-08', 6003, 0.250000, 0.000000000, 'USD', 'RELEASED', CURRENT_TIMESTAMP),
    (6104, (SELECT id FROM auth_users WHERE email = 'huongnn2201@gmail.com'), '2026-08', 6004, 0.035000, 0.000000000, 'USD', 'RELEASED', CURRENT_TIMESTAMP),
    ...
    (6109, (SELECT id FROM auth_users WHERE email = 'huongnn2201@gmail.com'), '2026-08', 6009, 0.035000, 0.000000000, 'USD', 'RELEASED', CURRENT_TIMESTAMP),
...
VALUES
    ...
    ('vieneu-ngoc-huyen-v2', 'VIENEU', 'Ngọc Huyền v2', 'vi-VN', 'FEMALE', NULL, '{"style":"natural","local":true,"sdkVoiceName":"Ngọc Huyền v2"}'::jsonb)
