...
export const PresetCard: React.FC<PresetCardProps> = ({ preset, isSelected = false, onClick }) => (
  <article className={cn("group overflow-hidden rounded-2xl border bg-surface shadow-md transition-colors", isSelected ? "border-purple-500 ring-2 ring-purple-500/50" : "border-slate-800/90 hover:border-slate-700")}>
