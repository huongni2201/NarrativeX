...
public record NarrationSpan(
  ...
  public NarrationSpan {
    ...
    if (chapterTextStart < 0 || chapterTextEnd < chapterTextStart) throw new IllegalArgumentException("invalid chapter text span");
    if (globalTextStart < 0 || globalTextEnd < globalTextStart) throw new IllegalArgumentException("invalid global text span");
    if (globalAudioStartMs < 0 || globalAudioEndMs <= globalAudioStartMs) throw new IllegalArgumentException("invalid audio span");
