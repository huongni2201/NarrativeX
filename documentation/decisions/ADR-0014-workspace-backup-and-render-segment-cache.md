...
- Desktop storage usage reports include assets, artifacts, temporary render work, derived segment cache, and retained backup snapshots so the Settings total reflects all local bytes owned by the project.
