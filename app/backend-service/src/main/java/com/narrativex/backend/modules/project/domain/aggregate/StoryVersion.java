...
public final class StoryVersion extends DomainEntity {
    ...
    private StoryVersion(Long id, long rowVersion, Long projectId, int versionNumber, String content,
                         String sourceLanguage, StoryVersionStatus status, ModerationDecision moderationDecision,
    ...
    public static StoryVersion rehydrate(Long id, long rowVersion, Long projectId, int versionNumber,
                                         String content, String sourceLanguage, StoryVersionStatus status,
                                         ModerationDecision moderationDecision, boolean rightsAttested,
