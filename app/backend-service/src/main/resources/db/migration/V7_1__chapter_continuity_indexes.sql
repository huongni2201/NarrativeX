-- NarrativeX pre-release baseline slice: continuity/checkpoint access paths.
...
CREATE UNIQUE INDEX uq_analysis_checkpoint_identity
    ON analysis_checkpoints (generation_job_id, step_key, input_fingerprint);
