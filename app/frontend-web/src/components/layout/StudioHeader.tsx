      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative pl-3 border-l border-slate-800" ref={menuRef}>
          ...
          {isProfileMenuOpen && (
            <div
              role="menu"
              className="absolute right-0 mt-2 w-48 rounded-xl bg-[#0d1420] border border-slate-800 shadow-2xl py-1 z-50 animate-in fade-in zoom-in-95 duration-150"
            >
              ...
              <div className="p-1 space-y-0.5">
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-1.5 rounded-lg text-xs text-rose-400 hover:bg-rose-950/40 hover:text-rose-300 flex items-center gap-2 transition-colors font-medium disabled:cursor-wait disabled:opacity-60"
                >
