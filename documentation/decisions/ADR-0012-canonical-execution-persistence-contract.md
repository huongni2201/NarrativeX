...
- The consolidated V1 baseline defines the canonical job types as `STORY_ANALYZE`, `CHAPTER_ANALYZE`,
...
- The consolidated V1 baseline defines the canonical resource classes as the currently implemented
