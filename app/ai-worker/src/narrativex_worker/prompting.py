...
def build_chapter_analysis_prompt(request: ChapterAnalysisRequest) -> str:
    ...
    return (
        ...
        "field must be written in SOURCE_LANGUAGE, including names, aliases, descriptions, character "
        "bible and appearance text, scene titles, narration, visual beat titles, and visual_intent. "
