...
public record NarrationPartSnapshot(
    UUID mediaAssetId, int sequence, String sha256, long durationMs) {
  public NarrationPartSnapshot {
    ...
    if (sha256 == null || !sha256.matches("^[0-9a-f]{64}$"))
      throw new IllegalArgumentException("sha256 must be sha256 hex");
