-- NarrativeX consolidated PostgreSQL/Flyway baseline.
-- This file intentionally contains the former V1-V6 migration contents because
-- the schema has not been applied to a shared environment yet.
...
-- -----------------------------------------------------------------------------
-- Durable domain foundation
-- Provider/media binaries stay outside PostgreSQL.
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- V1.8 control-plane foundation
-- User-facing policy decisions are durable PostgreSQL state.
-- -----------------------------------------------------------------------------
...
-- A project stores an assignment, never a cloned character.
-- -----------------------------------------------------------------------------
