...
public record NarrationAsset(
  ...
  public NarrationAsset {
    ...
    if (projectAssetId == null || projectAssetId <= 0)
      throw new IllegalArgumentException("projectAssetId must be positive");
    ...
    if (codec == null || codec.isBlank())
      throw new IllegalArgumentException("codec must not be blank");
