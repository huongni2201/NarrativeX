...
@Entity
@Table(name="stage_attempts",uniqueConstraints=@UniqueConstraint(name="uk_stage_attempts_job_stage_number",columnNames={"generation_job_id","stage_name","attempt_number"}))
public class StageAttemptJpaEntity extends JpaAuditedEntity {
    @Column(name="generation_job_id",nullable=false) private Long generationJobId;
    @Column(name="stage_name",nullable=false,length=64) private String stageName;
