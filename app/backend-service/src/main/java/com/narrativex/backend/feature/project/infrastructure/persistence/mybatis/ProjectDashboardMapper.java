...
public interface ProjectDashboardMapper extends NarrativeXMyBatisMapper {
  ...
  ProjectDashboardCountsRow findDashboardCounts(@Param("query") String query);

  int addFavorite(@Param("projectId") UUID projectId);

  int removeFavorite(@Param("projectId") UUID projectId);
}
