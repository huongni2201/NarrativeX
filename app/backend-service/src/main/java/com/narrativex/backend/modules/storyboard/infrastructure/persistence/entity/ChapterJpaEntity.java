...
@Entity
@Table(name = "chapters", uniqueConstraints = @UniqueConstraint(name = "uk_chapters_story_order", columnNames = {"story_version_id", "order_index"}))
public class ChapterJpaEntity extends JpaAuditedEntity {
    @Column(name = "story_version_id", nullable = false) private Long storyVersionId;
    ...
    @Column(name = "estimated_duration_ms") private Long estimatedDurationMs;
    @Column(name = "generation_progress", nullable = false) private int generationProgress;
    @Column(name = "source_story_version_id") private Long sourceStoryVersionId;
    @Column(name = "inherited_snapshot_hash", length = 128) private String inheritedSnapshotHash;
