...
type ActivityId = "projects" | "assets" | "characters" | "story" | "scenes" | "voice" | "music" | "subtitles" | "transitions" | "effects" | "templates" | "settings";
...
export function App() {
  const [activity, setActivity] = useState<ActivityId>("projects");
  const [screen, setScreen] = useState<ActivityId | "editor">("editor");
