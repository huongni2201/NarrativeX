...
CREATE TABLE storyboard_revisions (
    ...
    status VARCHAR(24) NOT NULL DEFAULT 'DRAFT',
    content_variant_id BIGINT REFERENCES chapter_content_variants(id),
...
VALUES
    ('narrativex-en-us-female-1', 'NARRATIVEX', 'Clara', 'en-US', 'FEMALE', NULL, '{"style":"warm","supportsSpeakingRate":true,"supportsVoiceClone":false,"supportsBatch":false,"sampleRateHz":48000,"executionSemantics":"EXTERNAL_DURABLE"}'::jsonb),
    ('narrativex-vi-vn-female-1', 'NARRATIVEX', 'Mai', 'vi-VN', 'FEMALE', NULL, '{"style":"natural","supportsSpeakingRate":true,"supportsVoiceClone":false,"supportsBatch":false,"sampleRateHz":48000,"executionSemantics":"EXTERNAL_DURABLE"}'::jsonb),
    ('narrativex-vi-vn-male-1', 'NARRATIVEX', 'An', 'vi-VN', 'MALE', NULL, '{"style":"calm","supportsSpeakingRate":true,"supportsVoiceClone":false,"supportsBatch":false,"sampleRateHz":48000,"executionSemantics":"EXTERNAL_DURABLE"}'::jsonb),
    ('vieneu-ngoc-huyen-v2', 'VIENEU', 'Ngọc Huyền v2', 'vi-VN', 'FEMALE', NULL, '{"style":"natural","local":true,"sdkVoiceName":"Ngọc Huyền v2","region":"Bắc","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-minh-duc', 'VIENEU', 'Minh Đức', 'vi-VN', 'MALE', NULL, '{"style":"natural","local":true,"sdkVoiceName":"Minh Đức","region":"Bắc","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-truc-ly', 'VIENEU', 'Trúc Ly', 'vi-VN', 'FEMALE', NULL, '{"style":"gentle","local":true,"sdkVoiceName":"Trúc Ly","region":"Bắc","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-mai-anh', 'VIENEU', 'Mai Anh', 'vi-VN', 'FEMALE', NULL, '{"style":"expressive","local":true,"sdkVoiceName":"Mai Anh","region":"Bắc","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-quynh-anh', 'VIENEU', 'Quỳnh Anh', 'vi-VN', 'FEMALE', NULL, '{"style":"clear","local":true,"sdkVoiceName":"Quỳnh Anh","region":"Bắc","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-doan-trang', 'VIENEU', 'Đoan Trang', 'vi-VN', 'FEMALE', NULL, '{"style":"warm","local":true,"sdkVoiceName":"Đoan Trang","region":"Bắc","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-pham-tuyen', 'VIENEU', 'Phạm Tuyên', 'vi-VN', 'MALE', NULL, '{"style":"formal","local":true,"sdkVoiceName":"Phạm Tuyên","region":"Bắc","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-quang-son', 'VIENEU', 'Quang Sơn', 'vi-VN', 'MALE', NULL, '{"style":"narrative","local":true,"sdkVoiceName":"Quang Sơn","region":"Trung","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-ngoc-tran', 'VIENEU', 'Ngọc Trân', 'vi-VN', 'FEMALE', NULL, '{"style":"melodic","local":true,"sdkVoiceName":"Ngọc Trân","region":"Trung","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-adam', 'VIENEU', 'Adam', 'vi-VN', 'MALE', NULL, '{"style":"standard","local":true,"sdkVoiceName":"Adam","region":"Nam","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-xuan-vinh', 'VIENEU', 'Xuân Vĩnh', 'vi-VN', 'MALE', NULL, '{"style":"deep","local":true,"sdkVoiceName":"Xuân Vĩnh","region":"Nam","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-thai-son', 'VIENEU', 'Thái Sơn', 'vi-VN', 'MALE', NULL, '{"style":"energetic","local":true,"sdkVoiceName":"Thái Sơn","region":"Nam","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-thuy-dung', 'VIENEU', 'Thùy Dung', 'vi-VN', 'FEMALE', NULL, '{"style":"soft","local":true,"sdkVoiceName":"Thùy Dung","region":"Nam","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-my-duyen', 'VIENEU', 'Mỹ Duyên', 'vi-VN', 'FEMALE', NULL, '{"style":"bright","local":true,"sdkVoiceName":"Mỹ Duyên","region":"Nam","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-minh-triet', 'VIENEU', 'Minh Triết', 'vi-VN', 'MALE', NULL, '{"style":"confident","local":true,"sdkVoiceName":"Minh Triết","region":"Nam","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-duc-tri', 'VIENEU', 'Đức Trí', 'vi-VN', 'MALE', NULL, '{"style":"mature","local":true,"sdkVoiceName":"Đức Trí","region":"Nam","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb),
    ('vieneu-thuc-doan', 'VIENEU', 'Thục Đoan', 'vi-VN', 'FEMALE', NULL, '{"style":"friendly","local":true,"sdkVoiceName":"Thục Đoan","region":"Nam","supportsSpeakingRate":false,"supportsVoiceClone":true,"supportsBatch":true,"sampleRateHz":48000,"executionSemantics":"LOCAL_RETRYABLE"}'::jsonb)
