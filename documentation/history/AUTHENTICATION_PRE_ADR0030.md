# Historical Authentication and Ownership Workflow (Pre-ADR-0030)

> Status: Historical / Superseded by ADR-0030
> Do not use as implementation guidance. NarrativeX is a single-user local-first application per ADR-0030 with no application user/account/session identity or login flow.
