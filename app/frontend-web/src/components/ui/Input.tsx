      ...
      <div className="w-full space-y-1">
        <div className="relative flex items-center w-full">
          ...
          <input
            ...
            className={cn(
              "w-full bg-[#0a0f1d] border border-slate-800 rounded-lg px-3.5 py-2 text-sm text-slate-100 placeholder:text-slate-400",
    ...
    return (
      <div className="w-full space-y-1">
        <textarea
          ...
          aria-describedby={describedBy}
          className={cn(
            "w-full bg-[#0a0f1d] border border-slate-800 rounded-lg p-3 text-sm text-slate-100 placeholder:text-slate-400",
