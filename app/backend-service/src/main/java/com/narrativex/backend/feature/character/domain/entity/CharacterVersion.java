...
public final class CharacterVersion extends DomainEntity {
    ...
    public static CharacterVersion create(
        ...
        return new CharacterVersion(
            null, 0L, characterId, versionNumber, bible, visualPrompt,
            masterAssetId, referenceAssetIds, CharacterVersionStatus.DRAFT, null, null);
    }
    ...
    public static CharacterVersion rehydrate(
            ...
            String lockedBy) {
        return new CharacterVersion(
            id, rowVersion, characterId, versionNumber, bible, visualPrompt,
