...
- **Images**: `next/image` for local/trusted imagery; arbitrary environment-specific backend media remains native lazy-loaded until a stable trusted media hostname is part of the storage contract
