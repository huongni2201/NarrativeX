...
Remaining JPA/JDBC boundaries are migration work, not the final architecture. StoryVersion is the next low-contained boundary; generation execution/outbox/quota paths follow based on concurrency/value.
