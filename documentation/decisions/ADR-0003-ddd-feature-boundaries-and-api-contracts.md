...
- Aggregate methods own business invariants and state transitions. Application use cases own orchestration across aggregates, repositories and external systems. Infrastructure concerns such as Redis, MinIO/S3 and provider SDKs never belong in an aggregate.
