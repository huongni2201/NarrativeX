...
The previous granular/transitional ADR records were consolidated into the 12 canonical files above. Use a new sequential ADR (`ADR-0013+`) for any new cross-cutting architecture decisions.
