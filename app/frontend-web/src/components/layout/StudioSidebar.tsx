    ...
    <aside className="w-64 bg-[#090e17] border-r border-slate-800/80 flex flex-col justify-between shrink-0 h-screen sticky top-0 select-none z-20">
      ...
      <div>
        <div className="p-5 border-b border-slate-800/60 flex items-center justify-between">
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center shadow-[0_0_15px_rgba(124,58,237,0.5)] group-hover:scale-105 transition-transform">
      ...
      <div className="p-3 space-y-3">
        ...
        <div className="space-y-1 pt-2 border-t border-slate-800/60">
          <button
            onClick={() => {}}
            className="w-full flex items-center justify-between px-3.5 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-slate-200 hover:bg-slate-800/40 transition-colors"
          >
          ...
          <button
            onClick={() => {}}
            className="w-full flex items-center gap-3 px-3.5 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-slate-200 hover:bg-slate-800/40 transition-colors"
          >
