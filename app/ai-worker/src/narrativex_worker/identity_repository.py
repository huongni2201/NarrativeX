"""Project-scoped AI identity resolution for Chapter continuity materialization."""
...
class IdentityAwareWorkerRepository(WorkerRepository):
    """Worker repository that treats durable project identity keys as relational identity."""
        ...
        for character in result.characters:
            ...
            if project_character_id is None:
                ...
                if match is not None:
                    ...
                    project_character_id = await IdentityAwareWorkerRepository._create_character(
                        connection,
                        claimed,
                        character.name,
                        character.aliases,
