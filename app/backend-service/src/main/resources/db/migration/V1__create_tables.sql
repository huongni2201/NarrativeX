...
-- This baseline is intended for clean database creation and intentionally replaces
-- the previous V1..V7 migration chain.
...
-- -----------------------------------------------------------------------------
-- Baseline marker and authentication
-- -----------------------------------------------------------------------------
...
CREATE TABLE chapter_content_variants (
    ...
    CONSTRAINT ck_chapter_content_variants_source
        CHECK (
            (variant_type = 'ORIGINAL' AND source_variant_id IS NULL)
            OR
...
CREATE TABLE local_media_materializations (
    ...
    local_device_id UUID REFERENCES local_devices(id) ON DELETE CASCADE,
...
-- -----------------------------------------------------------------------------
-- Control plane, notifications, preferences and audit
-- -----------------------------------------------------------------------------
