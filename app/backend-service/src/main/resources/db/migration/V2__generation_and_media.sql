-- NarrativeX pre-release baseline: generation execution and media assets.
...
-- -----------------------------------------------------------------------------
-- Project media and voice-reference assets
-- -----------------------------------------------------------------------------
...
CREATE TABLE voice_reference_assets (
    ...
    updated_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
    row_version BIGINT NOT NULL DEFAULT 0,
    CONSTRAINT uq_voice_reference_assets_checksum UNIQUE (sha256),
