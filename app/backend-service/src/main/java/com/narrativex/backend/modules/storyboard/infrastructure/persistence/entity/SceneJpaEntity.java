...
@Entity
@Table(name = "scenes", uniqueConstraints = @UniqueConstraint(name = "uk_scenes_chapter_order", columnNames = {"chapter_id", "order_index"}))
public class SceneJpaEntity extends JpaAuditedEntity {
    ...
    @Column(name = "narration", columnDefinition = "TEXT") private String narration;
