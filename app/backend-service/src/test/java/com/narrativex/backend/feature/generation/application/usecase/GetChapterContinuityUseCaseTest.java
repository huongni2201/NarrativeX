...
class GetChapterContinuityUseCaseTest {
  ...
  void readsContinuityWithoutAcquiringChapterWriteLock() {
    ...
    var useCase = new GetChapterContinuityUseCase(currentUserId, projectAccess, continuityRepository);
    ...
    assertThat(useCase.execute(projectId, chapterId)).isEqualTo(current);
